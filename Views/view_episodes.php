...
$SERVEUR_PATH="http://".$_SERVER['HTTP_HOST'].'/ArrakisWeb/';
		...
		foreach ($Episodes as $labelShow=>$showID)
		{
			...
			if ($Channels!='Kodi')
			{
				echo "<br><a href='".$SERVEUR_PATH."index.php/Watch/index/".$Channels."_".$Categories."_".$Shows."_".$showID."'>".$labelShow."</a></br>";
		
			}
			else
			{
				echo "<br><a href='".$SERVEUR_PATH."index.php/Watch/index/".$Channels."_".$Categories."_".$Shows."_".$Seasons."_".$showID."'>".$labelShow."</a></br>";
			}
		}
