...
class FranceTV extends ScrappingCURL implements IChannel
{
	...
	public function Shows($categorySelected)
	{
		$this->FRANCETV_CATEGORIES=Categories();
		...
		return var_dump($this->FRANCETV_CATEGORIES);//$currentprog;//var_dump($this->JSON_RESULT_FRANCETV['programmes']);//$this->FRANCETV_SHOWS;
	}
