...
class Watch extends CI_Controller
{
	public function index($id)
	{
    	...
    	elseif ($Channel[0]=='Kodi')
    	{
    		...
    		$hostNas=str_replace(strrev(strrev(explode('/',$urlEpisode)[0])),'',$urlEpisode);
    		$comm='sudo mount.cifs o'.$hostNas.' /var/www/html/ArrakisWeb/SRVNAS_WEB -o guest,workgroup=WORKGROUP,users';
